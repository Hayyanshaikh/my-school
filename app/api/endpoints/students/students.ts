 ...
 * @summary Create a new student
 */
export const useStudentsControllerCreate = <TError = void, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof studentsControllerCreate>>,
      TError,
 ...
 */
export const studentsControllerFindAll = (signal?: AbortSignal) => {
  return axiosInstance<void>({
    url: `http://localhost:3001/students`,
    method: "GET",
    signal,
...
export const getStudentsControllerFindAllQueryKey = () => {
  return [`http://localhost:3001/students`] as const;
};
...
>(options?: {
  ...
  const queryKey =
    queryOptions?.queryKey ?? getStudentsControllerFindAllQueryKey();

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof studentsControllerFindAll>>
  > = ({ signal }) => studentsControllerFindAll(signal);
...
export const getStudentsControllerFindOneQueryKey = (id?: string) => {
  return [`http://localhost:3001/students/${id}`] as const;
};
 ...
 * @summary Update a student by ID
 */
export const useStudentsControllerUpdate = <TError = void, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof studentsControllerUpdate>>,
      TError,
 ...
 * @summary Delete a student by ID
 */
export const useStudentsControllerRemove = <TError = void, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof studentsControllerRemove>>,
      TError,
